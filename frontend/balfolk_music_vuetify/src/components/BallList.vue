<template>
    <div>
        ...
        <v-row>
            ...
            <v-col cols="6">
            <v-select variant="underlined" label="Country" v-model="countriesSelected" item-value="alpha_2" item-title="name"
                multiple :items="getCountriesToSelect()" @update:modelValue="refreshEventData()">
                        ...
                        <v-row dense>
                            <v-col v-for="item in items" :key="item.id" cols="12" lg="4" md="6" sm="12">
                                ...
                                <router-link style="text-decoration: none; color: inherit;"
                                    :to="{ name: 'BallDetail', params: { id: item.raw.id } }">
                                    <v-sheet rounded class="d-flex" color="grey-lighten-3">
                                        <v-row align="center" no-gutters rounded class="d-flex" color="grey-lighten-3">
                                            ...
                                            <v-col no-gutters
                                                ...
                                                class="pa-1 fill-height" cols="3" md="3">
                                                <v-row no-gutters justify="center" style="line-height: 20px;height: 22px;"
...
function refreshEventData(){
    fetchEventData('ball', objects, loading, countriesSelected.value);
}
